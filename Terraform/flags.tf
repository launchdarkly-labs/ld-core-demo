...
resource "launchdarkly_feature_flag" "show-cards-section-component" {
  project_key = var.project_key
...
resource "launchdarkly_feature_flag" "show-hero-redesign" {
  project_key = var.project_key
...
resource "launchdarkly_feature_flag" "show-different-hero-image-string" {
  project_key = var.project_key
