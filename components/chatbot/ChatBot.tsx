      ...
      {isOpen && (
        <Card className="max-w-md w-full mx-auto">
          <CardHeader className="flex flex-row items-center">
            ...
            <Button variant="ghost" size="icon" className="ml-auto rounded-full" onClick={() => setIsOpen(false)}>
          ...
          <CardContent className="h-[400px] overflow-y-auto">
            <div className="space-y-4">
              ...
              <div className="flex w-max max-w-[75%] flex-col gap-2 rounded-lg px-3 py-2 text-sm bg-gray-100 dark:bg-gray-800">
                <p>Of course, I'd be happy to help! What seems to be the issue with your account?</p>
              </div>
              <div className="flex w-max max-w-[75%] flex-col gap-2 rounded-lg px-3 py-2 text-sm ml-auto bg-gray-900 text-gray-50 dark:bg-gray-50 dark:text-gray-900">
                <p>Well, I'm not able to log in and I'm not sure why. Can you please check on that for me?</p>
              </div>
              <div className="flex w-max max-w-[75%] flex-col gap-2 rounded-lg px-3 py-2 text-sm bg-gray-100 dark:bg-gray-800">
                <p>Okay, let me take a look. Can you please provide me with your account email address?</p>
              </div>
            </div>
          </CardContent>
          <CardFooter>
