  ...
  return (
    <div className="w-full sm:w-[425px] 3xl:h-[500px] bg-white font-audimat shadow-xl">
      <div className="flex flex-col justify-center mx-auto text-center">
        ...
        <p className="text-3xl sm:text-4xl font-sohnelight pb-12 3xl:pb-24 !font-thin">Toggle<span className="!font-extrabold">Bank</span></p>
      </div>
      <div>
      ...
      <Input placeholder="Email" className="mb-8 3xl:mb-24 outline-none border-0 border-b-2 text-xl" />
        ...
        <Button onClick={handleLogin} className="w-full h-full mx-auto font-audimat rounded-none bg-blue-500 text-xl">Login with SSO</Button>
      </div>
      <div className="flex flex-col gap-y-2 sm:flex-row sm:gap-x-4 justify-between px-8 pb-8 pt-4 3xl:pt-14">
        ...
        <div>
          <p>Don't have an account? <a href='/bank' className='text-blue-600 ml-2'>Sign Up</a></p>
        </div>
      </div>
    </div>
  )
