...
const industryNavigation: any = {
  government: {
    slogan: "Reducing risk in government.",
    columnOneHeader: "About BRR",
    columnOne: [
      { name: "Ask BRR", href: "#" },
      { name: "Contact Us", href: "#" },
      { name: "Site Map", href: "#" },
      { name: "Policies and Links", href: "#" },
    ],
    columnTwoHeader: "Careers",
    columnTwo: [
      { name: "Blog", href: "#" },
      { name: "Press", href: "#" },
    ...
    columnThreeHeader: "FOIA",
    columnThree: [
      { name: "Accessibility Statement", href: "#" },
      { name: "Privacy Policy", href: "#" },
      { name: "Non-Discrimination Statement", href: "#" },
      { name: "Vulnerability Disclosure Policy", href: "#" },
    ],
    columnFourHeader: "Agency Financial Reports",
    columnFour: [
      { name: "BRR FAQs", href: "#" },
      { name: "BRR Archive", href: "#" },
      { name: "The White House", href: "#" },
      { name: "USA.gov", href: "http://usa.gov/" },
    ],
  },
};
