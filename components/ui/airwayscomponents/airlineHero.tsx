    ...
    <section className={`airline-hero-image ${showSearch ? "blur-lg" : ""}`}>
      <div className="flex flex-col">
        <div className={`relative`}>
          ...
          <div className="h-48 w-full sm:h-64 lg:absolute lg:top-0 lg:right-0 lg:h-full lg:w-1/2 flex justify-center">
            {launchClubLoyalty && isLoggedIn && !enrolledInLaunchClub && (
              <motion.div
                ...
                bg-gradient-airline shadow-2xl mb-[5rem] lg:my-32 relative rounded-lg text-white"
              >
