...
const AirlineInfoCard = ({
  ...
  return (
    <Card className="flex w-full h-[550px] lg:h-[430px] border-0 flex-col animate-fade-in grid-rows-2
     bg-slate-900 z-0 !rounded-none relative">
      ...
      <div className="pt-[2.5rem] px-[2.5rem] flex flex-col gap-y-2 bg-gradient-airways h-full">
        ...
        <ArrowRight className="h-10 w-10 sm:h-6 sm:w-6 text-white  mt-auto absolute bottom-0 mb-6" />
      </div>
    </Card>
  );
};
